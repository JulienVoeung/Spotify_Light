...
public class DeleteSongController {
    ...
    public DeleteSongController(PlaylistRepository playlistRepository, UserRepository userRepository) {
    ...
    public void run() {
        ...
        do
        {
            System.out.println("Delete song to Playlist");
            ...
            var responseMessage = playlistCreationRequestUseCase.deleteSongFromPlaylist(songChosen, email, playlistName, this.userRepository);
