...
public class DeletePlaylistController {
    ...
    public DeletePlaylistController(PlaylistRepository playlistRepository, UserRepository userRepository) {
    ...
    public void run() {
        ...
        do
        {
            ...
            var responseMessage = playlistCreationRequestUseCase.deletePlaylist(playlistName);
